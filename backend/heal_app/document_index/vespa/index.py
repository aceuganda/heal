...
from heal_app.configs.app_configs import DOCUMENT_INDEX_NAME
from heal_app.configs.app_configs import LOG_VESPA_TIMING_INFORMATION
from heal_app.configs.app_configs import VESPA_DEPLOYMENT_ZIP
from heal_app.configs.app_configs import VESPA_HOST
from heal_app.configs.app_configs import VESPA_PORT
from heal_app.configs.app_configs import VESPA_TENANT_PORT
from heal_app.configs.chat_configs import DOC_TIME_DECAY
from heal_app.configs.chat_configs import EDIT_KEYWORD_QUERY
from heal_app.configs.chat_configs import HYBRID_ALPHA
from heal_app.configs.chat_configs import NUM_RETURNED_HITS
from heal_app.configs.chat_configs import TITLE_CONTENT_RATIO
from heal_app.configs.constants import ACCESS_CONTROL_LIST
from heal_app.configs.constants import BLURB
from heal_app.configs.constants import BOOST
from heal_app.configs.constants import CHUNK_ID
from heal_app.configs.constants import CONTENT
from heal_app.configs.constants import DOC_UPDATED_AT
from heal_app.configs.constants import DOCUMENT_ID
from heal_app.configs.constants import DOCUMENT_SETS
from heal_app.configs.constants import EMBEDDINGS
from heal_app.configs.constants import HIDDEN
from heal_app.configs.constants import INDEX_SEPARATOR
from heal_app.configs.constants import METADATA
from heal_app.configs.constants import METADATA_LIST
from heal_app.configs.constants import PRIMARY_OWNERS
from heal_app.configs.constants import RECENCY_BIAS
from heal_app.configs.constants import SECONDARY_OWNERS
from heal_app.configs.constants import SECTION_CONTINUATION
from heal_app.configs.constants import SEMANTIC_IDENTIFIER
from heal_app.configs.constants import SOURCE_LINKS
from heal_app.configs.constants import SOURCE_TYPE
from heal_app.configs.constants import TITLE
from heal_app.configs.constants import TITLE_EMBEDDING
from heal_app.configs.constants import TITLE_SEPARATOR
from heal_app.configs.model_configs import DOC_EMBEDDING_DIM
from heal_app.configs.model_configs import SEARCH_DISTANCE_CUTOFF
from heal_app.connectors.cross_connector_utils.miscellaneous_utils import (
    get_experts_stores_representations,
)
from heal_app.document_index.document_index_utils import get_uuid_from_chunk
from heal_app.document_index.interfaces import DocumentIndex
from heal_app.document_index.interfaces import DocumentInsertionRecord
from heal_app.document_index.interfaces import UpdateRequest
from heal_app.document_index.vespa.utils import remove_invalid_unicode_chars
from heal_app.indexing.models import DocMetadataAwareIndexChunk
from heal_app.indexing.models import InferenceChunk
from heal_app.search.models import IndexFilters
from heal_app.search.search_runner import embed_query
from heal_app.search.search_runner import query_processing
from heal_app.search.search_runner import remove_stop_words_and_punctuation
from heal_app.utils.batching import batch_generator
from heal_app.utils.logger import setup_logger
from heal_app.utils.threadpool_concurrency import run_functions_tuples_in_parallel
...
class VespaIndex(DocumentIndex):
    ...
    def ensure_indices_exist(self, embedding_dim: int = DOC_EMBEDDING_DIM) -> None:
        ...
        vespa_schema_path = os.path.join(
            os.getcwd(), "heal_app", "document_index", "vespa", "app_config"
        )
