...
from heal_app.configs.app_configs import CONTINUE_ON_CONNECTOR_FAILURE
from heal_app.configs.app_configs import GOOGLE_DRIVE_FOLLOW_SHORTCUTS
from heal_app.configs.app_configs import GOOGLE_DRIVE_INCLUDE_SHARED
from heal_app.configs.app_configs import INDEX_BATCH_SIZE
from heal_app.configs.constants import DocumentSource
from heal_app.configs.constants import IGNORE_FOR_QA
from heal_app.connectors.cross_connector_utils.file_utils import read_pdf_file
from heal_app.connectors.cross_connector_utils.retry_wrapper import retry_builder
from heal_app.connectors.google_drive.connector_auth import (
    get_google_drive_creds_for_authorized_user,
)
from heal_app.connectors.google_drive.connector_auth import (
    get_google_drive_creds_for_service_account,
)
from heal_app.connectors.google_drive.constants import (
    DB_CREDENTIALS_DICT_DELEGATED_USER_KEY,
)
from heal_app.connectors.google_drive.constants import (
    DB_CREDENTIALS_DICT_SERVICE_ACCOUNT_KEY,
)
from heal_app.connectors.google_drive.constants import DB_CREDENTIALS_DICT_TOKEN_KEY
from heal_app.connectors.interfaces import GenerateDocumentsOutput
from heal_app.connectors.interfaces import LoadConnector
from heal_app.connectors.interfaces import PollConnector
from heal_app.connectors.interfaces import SecondsSinceUnixEpoch
from heal_app.connectors.models import Document
from heal_app.connectors.models import Section
